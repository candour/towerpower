...
object TutorialContent {
    ...
    val STALL_TUTORIALS = mapOf(
        ...
        StallType.ICE_KACHANG to TutorialData(
            ...
            type = TutorialType.STALL,
            title = "Auntie's Ice Kachang Cart",
