...
| FIX-017 | 2026-07-25 | Fixed stat inconsistencies between `Registry.kt` and documentation (`STALL_STATS.md`, `CUSTOMER_STATS.md`, `AGENTS.md`) for Chicken Rice, Durian, and Tiger Mom. | Resolved |
