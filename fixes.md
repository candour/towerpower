...
| FIX-017 | 2026-07-25 | Corrected base stats in `Registry.kt` for Chicken Rice, Durian, and Tiger Mom to align with `STALL_STATS.md` and `CUSTOMER_STATS.md`. | Resolved |
