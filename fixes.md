...
| REF-008 | 2025-06-12 | Refactored `handleStallFiring` and `StallBehavior` to optimize enemy targeting. Introduced pre-sorted enemy lists and encapsulated targeting logic in behaviors, reducing average-case Line-of-Sight checks from $O(S \times E)$ through priority-based early termination. | Resolved |
