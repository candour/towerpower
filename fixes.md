...
| FIX-017 | 2026-07-28 | Synchronized base stats and enemy HP scaling in `Registry.kt` with `STALL_STATS.md` and `CUSTOMER_STATS.md`. Corrected Tiger Mom base HP (80f), Chicken Rice damage (10f), and Durian damage (150f). Updated HP scaling from 1.05 to 1.07 and unified documentation examples. | Resolved |
